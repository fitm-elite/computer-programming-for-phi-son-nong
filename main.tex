...
\node (stop) [startstop, below of=output, yshift=-0.5cm] {Stop};
...
\draw [arrow] (jrange.east) -- ++(4cm,0) |- ++(0,-4.5cm) |- ++(-12.5cm,0) |- node[anchor=east, xshift=9.5cm, yshift=-4.1cm] {False} (irange.west);

\draw [arrow] (output.west) -- ++(-1cm,0) |- (jrange.west);

\draw [arrow] (irange.east) -- ++(5cm,0) |- node[anchor=east, xshift=-4cm, yshift=10.6cm] {False} (stop.east);
