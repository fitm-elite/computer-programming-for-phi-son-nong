...
\begin{titlepage}
    ...
    {\textlight{\textcolor{darkgray}{*ยงยุทธ ชวนขุนทด, เมธัส ทองจันทร์, ศุภกร จิรศิริวรกุล, มชัญชยา ประยูรมณี}}\par}
...
\node (range) [decision, below of=start, yshift=-1.5cm] {i in range(0, 6, 2)};
...
\textlight{หากต้องการวนซ้ำผ่านรายการ (List) หรือทูเพิล (Tuple) โดยตรง สามารถใช้คำสั่ง \textcolor{magenta}{for} ได้โดยไม่ต้องใช้ \textcolor{gray}{range}}
